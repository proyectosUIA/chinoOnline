<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Empleados.master" CodeBehind="Employee.aspx.vb" Inherits="ElChinoOnline.Employee" %>
<asp:Content ID="Content3" ContentPlaceHolderID="Contenidoempleado" runat="server">

   <div id="Mantenimiento-empleado" class="row">
        <div class="col m3 l4">
            <br />
        </div>
        <div class="col s12 m6 l4 z-depth-4 card-panel center-block">
            <div class="employee-form center">
                <div class="row">
                ...
                |<div class="row margin">
                    <div class ="input-field col s3">
                         <asp:TextBox ID="Textnombre" runat="server" TextMode="SingleLine" CssClass="validate"></asp:TextBox>
